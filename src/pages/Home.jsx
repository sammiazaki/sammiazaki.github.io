...
export default function Home() {
  return (
    <div className="mx-auto max-w-6xl px-6 py-12">
      <div className="mb-12">
        <h1 className="text-4xl font-bold tracking-tight">Interactive Tutorials</h1>
        <p className="mt-3 text-lg text-slate-600">
          Noodle on ideas across math, philosophy, economics, and more — with live visualizations and quizzes.
        </p>
      </div>
